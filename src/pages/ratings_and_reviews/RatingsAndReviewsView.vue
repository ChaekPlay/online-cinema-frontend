    ...
    <div class="ratings-and-reviews view">
        ...
        <div class="reviews">
            <div class="review-header">
                ...
                <button class="btn btn-glass btn-icon-text label-lg" @click="$router.push('create-review')"><img
                        class="icon-sm" src="@/static/icons/plus.svg">Написать свою рецензию</button>
            </div>
